      ...
      <header className="w-full bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center shadow-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-blue-700 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all"
          >
